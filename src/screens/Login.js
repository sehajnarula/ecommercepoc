...
import {userSignIn,userGoogleSignIn} from "../redu/actions/UserActions";
...
const Login = ()=>{
    ...
    <SafeAreaProvider>
     ...
     <View style = {{flex:1}}>
     <Text style = {{fontFamily:fontFamilies.INTER.bold,color:'#FFFFFF',fontSize:36,marginLeft:12,includeFontPadding:false,marginTop:12}}>
     {"Welcome"}   
     </Text>
     <View style = {{top:100}}>
     <Text style = {{color:'#FFFFFF',fontFamily:fontFamilies.INTER.bold,includeFontPadding:false,fontSize:16,marginLeft:12}}>
     {"Email"}   
     </Text>
     <View style = {{paddingBottom:10,borderRadius:10,backgroundColor:"#323130",marginHorizontal:12,marginTop:12}}>
    ...
    <TextInput
     ...
     <Text style = {{color:'#FFFFFF',fontFamily:fontFamilies.INTER.bold,includeFontPadding:false,fontSize:16,marginLeft:12,marginTop:20}}>
     {"Password"}   
     </Text>
     <View style = {{paddingBottom:10,borderRadius:10,backgroundColor:"#323130",marginHorizontal:12,marginTop:12}}>
     <View style = {{flexDirection:'row'}}>
     ...
     <Text style = {{color:"#FFFFFF",fontFamily:fontFamilies.INTER.medium,fontSize:12,marginTop:12,textAlign:'right',marginEnd:12}}>
     {"Forget Password?"} 
     </Text>
     <TouchableOpacity
     activeOpacity={0.9}
     style = {{marginTop:20,backgroundColor:'#F0DCBC',marginHorizontal:12,borderRadius:4,justifyContent:'center',alignItems:'center',padding:10}}
     onPress={()=>{
      loginButtonPress();
     }}>
     ...
     <Text style = {{color:"#FFFFFF",fontFamily:fontFamilies.INTER.medium,fontSize:12,marginTop:12,textAlign:'center'}}>
     {"Or"} 
     </Text>
     ...
     <View style = {{padding:14,justifyContent:'center',width:54,height:54,borderRadius:40,borderColor:'#FFFFFF8F',borderWidth:1,backgroundColor:'#F0DCBC'}}>
     ...
     <Text style = {{color:"#FFFFFF",fontFamily:fontFamilies.INTER.regular,fontSize:16}}>
     {"Don't Have An Account?"} 
     </Text>
     <Text style = {{color:"#FFFFFF",fontFamily:fontFamilies.INTER.bold,fontSize:16,marginLeft:6}}
